...
* DSH - Shell scripting for the flipper zero. Uses a serial connection to interpret its own programming language. can use flipper cli commands, aswell as local python, and javascript. or anything else, you choose to port.
